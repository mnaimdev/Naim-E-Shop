                                        ...
                                        <td>
                                            <table width="220" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left"> <img
                                                                src="https://i.postimg.cc/28DZvnwX/logo.png"
                                                                width="80" alt="logo" border="0" /></td>
                                                    </tr>
                                                    <tr class="hiddenMobile">
                                                        <td height="40"></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            Hello,
                                                            {{ App\Models\BillingDetail::where('order_id', $order_id)->first()->name }}
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <br />
                                                            <small>
                                                                {{ App\Models\BillingDetail::where('order_id', $order_id)->first()->created_at->format('Y-m-d') }}
                                                            </small>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            @foreach (App\Models\OrderProduct::where('order_id', $order_id)->get() as $order)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <small>
                                                            {{ $order->rel_to_product->after_discount }}
                                                        </small>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    <strong>
                                                        {{ App\Models\Order::where('order_id', $order_id)->first()->total }}
                                                        TK
                                                    </strong>
                                                </td>
                                            </tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    {{ App\Models\BillingDetail::where('order_id', $order_id)->first()->email }}
                                                                    <br>
                                                                    T:
                                                                    {{ App\Models\BillingDetail::where('order_id', $order_id)->first()->phone }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    @php
                                                                        $payment_method = App\Models\BillingDetail::where('order_id', $order_id)->first()->payment_method;
                                                                        
                                                                        if ($payment_method == 1) {
                                                                            echo 'Cash on Delivery';
                                                                        } elseif ($payment_method == 2) {
                                                                            echo 'Pay with SSLCommerz';
                                                                        } else {
