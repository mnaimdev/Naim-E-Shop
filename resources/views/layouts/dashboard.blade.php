...
<head>
    ...
    <title>Samira - Admin Dashboard</title>
    <!-- Favicon icon -->
    ...
    <link href="{{ asset('/dashboard_assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}"
        rel="stylesheet">
    ...
    ***********************************-->
    <div id="main-wrapper">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <img width="20" src="{{ asset('/dashboard_assets/user.png') }}" alt="">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <img width="20" src="{{ asset('/dashboard_assets/category.png') }}" alt="">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <img width="20" src="{{ asset('/dashboard_assets/product.png') }}" alt="">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <img width="20" src="{{ asset('/dashboard_assets/group.png') }}" alt="">
                            <span class="nav-text ml-3">Role Management</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <img width="20" src="{{ asset('/dashboard_assets/giftbox.png') }}" alt="">
                            <span class="nav-text ml-3">Coupon</span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <img width="20" src="{{ asset('/dashboard_assets/order.png') }}" alt="">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://mnaimdev.com" target="_blank">Mohammad
                        Naim</a> 2023</p>
            </div>
        </div>
        <!--**********************************
